...
public class WorkbookFactory {
  ...
  public static KWorkbook getWorkbook(SpreadSheetType type, String filename, String encoding) throws KettleException {
    ...
    case STAX_POI: return new StaxPoiWorkbook(filename, encoding); // encoding is not used, perhaps detected automatically?
...
//    case STAX_POI: return new StaxPoiWorkbook(inputStream, encoding); // not supported yet!
